...
import HeroLandingScreen from "../screens/auth/HeroLandingScreen";
...
function AuthNavigator() {
  return (
    <AuthStack.Navigator screenOptions={{ headerShown: false }}>
      <AuthStack.Screen name="HeroLanding" component={HeroLandingScreen} />
          ...
          {user ? (
            <Stack.Group>
              ...
              <Stack.Screen
                ...
                options={DARK_HEADER("Safe Route")}
              />
              <Stack.Screen
                name="AI"
                component={AIShieldScreen}
                options={DARK_HEADER("AI Shield")}
              />
              <Stack.Screen
                name="Laws"
                component={SafetyLawsScreen}
                options={DARK_HEADER("Safety Laws")}
              />
              <Stack.Screen
                name="SelfDefense"
                component={SelfDefenseScreen}
                options={DARK_HEADER("Self Defense")}
              />
              <Stack.Screen
                name="Profile"
                component={ProfileScreen}
                options={DARK_HEADER("My Profile")}
              />
              <Stack.Screen
                name="Support"
                component={SupportScreen}
                options={DARK_HEADER("Support")}
              />
              <Stack.Screen
                name="Privacy"
                component={PrivacyScreen}
                options={DARK_HEADER("Privacy")}
              />
              <Stack.Screen
                name="Terms"
                component={TermsScreen}
                options={DARK_HEADER("Terms")}
              />
              <Stack.Screen
                name="IncidentDetail"

...
export default function SupportScreen() {
  const handleEmail = () => {
    Linking.openURL(
      "mailto:support@shieldher.app?subject=ShieldHer%20Support%20Request",
    );
  };
  ...
  const handleFAQ = () => {
    Linking.openURL("https://shieldher.app/faq").catch(() =>
      Alert.alert(
        "Unavailable",
        "Our FAQ page will be live soon. Contact support@shieldher.app for help.",
      ),
    );
  };
  ...
  const handleBugReport = () => {
    Linking.openURL(
      "mailto:bugs@shieldher.app?subject=Bug%20Report%20-%20Version%201.0&body=Please%20describe%20the%20bug%20you%20encountered:",
    );
  };
  ...
  return (
    <ScrollView style={s.root} contentContainerStyle={s.content}>
      ...
      <Text style={s.intro}>
        Need assistance or want to report an issue with the app? We're here to
      ...
      <Hoverable style={s.card} onPress={handleFAQ}>
        ...
        <View style={s.cardContent}>
          ...
          <Text style={s.cardDesc}>
            Read our guides on setting up your safety circle and using the SOS
            feature.
          </Text>
        </View>
      ...
      <Hoverable style={s.card} onPress={handleEmail}>
        ...
        <View style={s.cardContent}>
          ...
          <Text style={s.cardDesc}>
            Email our dedicated safety support team directly at
            support@shieldher.app.
          </Text>
        </View>
        <ChevronRight size={18} color={SUBTEXT} />
      </Hoverable>
      ...
      <Hoverable style={s.card} onPress={handleBugReport}>
        ...
        <View style={s.cardContent}>
          ...
          <Text style={s.cardDesc}>
            Found a glitch? Let us know so we can fix it immediately.
          </Text>
        </View>
        <ChevronRight size={18} color={SUBTEXT} />
      </Hoverable>

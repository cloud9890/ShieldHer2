  ...
  return (
    <Hoverable style={s.guardianCard} onPress={onPress}>
      <View style={s.guardianLeft}>
        <Animated.View
          style={[
            s.guardianDot,
            {
              backgroundColor: guardianOn ? SUCCESS : MUTED,
        ...
        <View>
          ...
          <Text
            style={[s.guardianStatus, { color: guardianOn ? SUCCESS : MUTED }]}
          >
      ...
      <View
        style={[
          s.guardianToggle,
          { backgroundColor: guardianOn ? SUCCESS : "#374151" },
        ]}
      >
        <View
          style={[
            s.guardianThumb,
            { alignSelf: guardianOn ? "flex-end" : "flex-start" },
          ]}
        />
      </View>
    </Hoverable>
